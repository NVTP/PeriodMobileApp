...
class AppTheme extends StatelessWidget {
  ...
  static const Color colorPrimary = const Color(0xFFE50019);
  static const Color colorPrimaryInfo = const Color(0xFF41A553);
  static const Color colorTable = const Color(0xFFF2FBFC);
  static const Color colorBg = const Color(0xFFD7DADC);
  static const Color colorPrimaryDark = const Color(0xFF73A0EA);
  static const Color colorPrimaryLight = const Color(0xFF02A0D7);
